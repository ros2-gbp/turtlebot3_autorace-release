...
%global pkg_name turtlebot3_autorace_mission
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-turtlebot3-autorace-mission
Version:        1.2.2
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Pyo <pyo@robotis.com> - 1.2.2-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Pyo <pyo@robotis.com> - 1.2.2-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Pyo <pyo@robotis.com> - 1.2.2-1
- Autogenerated by Bloom
